<?php
/**
 * Calculating the percentage of time difference between two specific times.
 *
 * @package WordPress
 * @subpackage CustodyAgreements.co
 */

/**
 * Retrieve percentage of time spent with the Kids during visitation hours. data
 *
 * @author Jamie Brewer
 * @email jamie.brwr@gmail.com
 *
 * @since 3.9.0
 * @uses 
 *
...
class srhTime {
    ...
    /**
	* Set the initial properties from the database query.
 	* 
 	* This function does most of the heavy lifting
    * filtering the timethrough different formats
    * to result in a human readable format.
    *
    */
...
*/
	...
	* Helper Funtions
	* 
 	* Helper functions for formatting the ouput.
    *
    */
	...
	public function getTwelveHourPickUp() {	$formatted_pickup_time = sprintf("%02d:%02d", $this->_pickup_hour, $this->_pickup_minute);
