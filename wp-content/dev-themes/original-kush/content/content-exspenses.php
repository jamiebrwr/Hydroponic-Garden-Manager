...
<tr class="gradeA odd">
	<td>
		...
		<div class="progress progress-striped active">
			<div id="progressbar" class="progress-bar progress-bar-primary" role="progressbar" aria-valuenow="<?php echo $partial_amount_spent; ?>" aria-valuemin="0" aria-valuemax="<?php echo $monetary_value_max; ?>" style="width: <?php echo $partial_amount_spent; ?>%"></div>
