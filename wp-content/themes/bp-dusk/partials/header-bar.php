			...
			<li>
				<div class="btn-group">
					...
					<ul class="dropdown-menu dropdown-menu-usermenu pull-right">
						<li><a href="/members/<?php echo $current_user->user_login; ?>/profile/"><i class="glyphicon glyphicon-user"></i> My Profile</a></li>
						<li><a href="/members/<?php echo $current_user->user_login; ?>/settings/"><i class="glyphicon glyphicon-cog"></i> Account Settings</a></li>
						<!-- <li><a href="#"><i class="glyphicon glyphicon-question-sign/"></i> Help</a></li> -->
						<li><a href="<?php echo wp_logout_url( home_url().'/signin/' ); ?>"><i class="glyphicon glyphicon-log-out"></i> Log Out</a></li>
					</ul>
				</div>
			</li>
			<li>
